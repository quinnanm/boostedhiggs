...
for d in sigs:
    d.subjets = d.fill_LP(
        LP_rw, h_mc, num_excjets=num_excjets, sys_variations=sig_sys_variations, prefix="", rescale_subjets="vec"
    )

for d in bkgs:
    d.subjets = d.fill_LP(
        LP_rw, h_bkg, num_excjets=num_excjets, sys_variations=bkg_sys_variations, prefix="", rescale_subjets="vec"
    )
