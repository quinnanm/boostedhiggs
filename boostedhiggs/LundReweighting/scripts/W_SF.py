...
n_pt_bins = 6
num_excjets = 2
pt_bins = array("f", [0.0, 50.0, 100.0, 200.0, 300.0, 450.0, 99999.0])
...
obs_attrs = {
    ...
    if m_cut_max < 200
    else (50, 230, 45, "m_{SD} [GeV]", "Events / 4 GeV"),
    ...
    "pt": (225, 825.0, 20, "p_{T}", "Events / 30 GeV"),
    "DeepAK8_W": (0.0, 1.0, 20, "DeepAK8 (W vs. QCD)", "Events / 0.05"),
    "DeepAK8_W_MD": (0.0, 1.0, 20, "DeepAK8-MD (W vs. QCD)", "Events / 0.05"),
}
...
d_tw_LP_weights = d_tw.reweight_LP(
    LP_rw,
    h_ratio,
...
clip_weights = np.clip(d_LP_weights, 0.0, 5.0)
make_histogram(
    clip_weights,
    "Reweighting factors",
    "b",
