...
class BTagCorrector:
    ...
    def addBtagWeight(self, jets, weights, label=""):
        ...
        weights.add(
            ...
            np.ones(len(nominal)),
            weightUp=combine(lightEff, self.lighttagSF(lightJets, "up"), lightPass),
        ...
        weights.add(
            ...
            np.ones(len(nominal)),
            weightUp=combine(bcEff, self.btagSF(bcJets, "up_correlated"), bcPass),
            weightDown=combine(bcEff, self.btagSF(bcJets, "down_correlated"), bcPass),
        )
        return nominal
