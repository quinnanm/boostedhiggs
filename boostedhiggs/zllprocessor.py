...
class ZllProcessor(processor.ProcessorABC):
    ...
    def process(self, events: ak.Array):
        ...
        # # dilepton selection
        self.add_selection(name="TwoLep", sel=(n_loose_muons >= 2), channel="mu")
        self.add_selection(name="TwoLep", sel=(n_loose_electrons >= 2), channel="ele")

        self.add_selection(name="OneTight", sel=(n_tight_muons >= 1), channel="mu")
        self.add_selection(name="OneTight", sel=(n_tight_electrons >= 1), channel="ele")
