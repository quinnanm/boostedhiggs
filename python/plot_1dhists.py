...
from utils import axis_dict, add_samples, color_by_sample, signal_by_ch, simplified_labels, color_by_sample
...
def plot_1dhists(year, channels, odir, var, samples, tag, logy):
    ...
    for ch in channels:
        ...
        for sample in samples:
            ...
            hep.histplot(hists[ch][var][{'samples': sample}], 
                         ax=ax, 
...
def main(args):
    ...
    print(f'Plotting...')
    plot_1dhists(args.year, channels, odir, args.var, args.samples.split(','), args.tag, args.logy)
