    ...
    for year in years:
        ...
        for ch in channels:
            for sample in samples[year][ch]:
                ...
                if ch == 'had':
                    try:
                        print(f"Sample {sample} has {num_events[year][sample][ch]['preselection']} events after cuts")
                    except:
                        print(f"Sample {single_sample} has {num_events[year][single_sample][ch]['preselection']} events after cuts")
