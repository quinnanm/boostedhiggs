    ...
    for yr in samples.keys():
        ...
        for sample in samples[yr][ch]:
            ...
            for parquet_file in parquet_files:
                ...
                select = select & select_fj_pt & select_fj_msd
...
def plot_stacked_hists(year, ch, odir, logy=True, add_data=True):
    ...
    if add_data and data:
        ...
        hep.histplot(data, ax=ax, histtype="errorbar", color="k", capsize=4, yerr=True, label=data_label, **data_err_opts)
