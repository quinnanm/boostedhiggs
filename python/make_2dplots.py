...
if __name__ == "__main__":
    ...
    # fj_pt vs lep_fj_dr:  python make_2dplots.py --year 2017 --odir hists --channels ele --vars fj_pt,lep_fj_dr      --make_hists --plot_hists --x_bins 100 --x_start 0 --x_end 500 --y_bins 100 --y_start 0.1 --y_end 2 --idir /eos/uscms/store/user/fmokhtar/boostedhiggs/
