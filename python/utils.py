...
axis_dict = {
    ...
    'met_over_pt': hist2.axis.Regular(0, 1, 50, name='var', label='MET/pt [GeV]', overflow=True),
    'tagger_score': hist2.axis.Regular(0, 1, 50, name='var', label='tagger_score', overflow=True),
}
