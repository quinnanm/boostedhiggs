...
if __name__ == "__main__":
    ...
    # run on lpc as:  python make_stacked_hists.py --year 2017 --odir hists/stacked_hists --pfnano --make_hists --plot_hists --channels ele,mu,had --idir /eos/uscms/store/user/fmokhtar/boostedhiggs/
