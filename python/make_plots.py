...
if __name__ == "__main__":
    # e.g.
    # run locally as: python make_plots.py --year 2017 --odir hists/stacked_hists --pfnano --make_hists --plot_hists --channels ele,mu,had
    # run on lpc as:  python make_plots.py --year 2017 --odir hists/stacked_hists --pfnano --make_hists --plot_hists --channels ele --idir /eos/uscms/store/user/fmokhtar/boostedhiggs/
